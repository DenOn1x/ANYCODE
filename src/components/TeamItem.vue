...
<template>
  <div class="our-team__item">
    ...
    <div class="our-team__content content-team">
      <div class="content-team__top">
        <div class="content-team__title">{{ title }}</div>
...
.our-team {
  &__item {
    ...
    border-radius: 10px;
    padding: 12px;
    background: linear-gradient(45deg, #7470ff 0%, rgba(255, 255, 255, .01) 35%);
    position: relative;
